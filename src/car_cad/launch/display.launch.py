...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'car_cad.urdf'
    xacro_file = "car_cad.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "car_cad"
    use_urdf = False
    # Position and orientation
    # [X, Y, Z]
    position = [0.0, 0.0, 1.0] #1.0, 1.3, 1.0
    # [Roll, Pitch, Yaw]
    orientation = [0.0, 0.0, 0.0]
    # Base Name or robot
    robot_base_name = "car_cad"
    ####### DATA INPUT END ##########
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("car_cad"), "rviz", "display_default.rviz"]
    )
